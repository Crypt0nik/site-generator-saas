...
# 🚀 Script d'installation automatique pour Mon Site Test
# Généré le $(date)
# Template: e-commerce

set -e  # Exit on any error

echo "🎉 Installation de votre site: Mon Site Test"
echo "================================================="
...
clone_project() {
    ...
    if [ -d "mon-site-test" ]; then
        log_warning "Le dossier mon-site-test existe déjà. Suppression..."
        rm -rf "mon-site-test"
    fi
    
    # Note: Remplacez cette URL par l'URL réelle de votre repository
    git clone https://github.com/votre-username/Projet-Dev-B2.git "mon-site-test"
    cd "mon-site-test"
...
configure_project() {
    ...
    sed -i '' "s/APP_NAME=.*/APP_NAME="Mon Site Test"/" .env
...
main() {
    echo ""
    log_info "Début de l'installation de Mon Site Test"
    ...
    echo "  cd mon-site-test"
    echo "  php artisan serve"
    echo ""
    echo "Votre site sera accessible sur: http://localhost:8000"
    echo ""
    echo "Configuration appliquée:"
    echo "  - Nom: Mon Site Test"
    echo "  - Template: e-commerce"
    echo "  - Fonctionnalités: auth, payment, blog"
    echo ""
}
